...
document.write('<link rel="stylesheet" type="text/css" href="' + TB.env['path'] + 'yui/calendar/assets/calendar.css" />');
document.write('<scr' + 'ipt src="' + TB.env['path'] + 'yui/calendar/calendar-min.js?v=2.4.0.js" type="text/javascript"></scr' + 'ipt>');
